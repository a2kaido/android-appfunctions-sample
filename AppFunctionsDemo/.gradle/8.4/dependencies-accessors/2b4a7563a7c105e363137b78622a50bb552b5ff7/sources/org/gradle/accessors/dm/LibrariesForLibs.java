...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxLibraryAccessors extends SubDependencyFactory {
        ...
        private final AndroidxAppfunctionsLibraryAccessors laccForAndroidxAppfunctionsLibraryAccessors = new AndroidxAppfunctionsLibraryAccessors(owner);
        ...
        /**
         * Returns the group of libraries at androidx.appfunctions
         */
        public AndroidxAppfunctionsLibraryAccessors getAppfunctions() {
            return laccForAndroidxAppfunctionsLibraryAccessors;
        }
    ...
    public static class AndroidxAppfunctionsLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public AndroidxAppfunctionsLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for appfunctions (androidx.appfunctions:appfunctions)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> asProvider() {
                return create("androidx.appfunctions");
        }

            /**
             * Creates a dependency provider for compiler (androidx.appfunctions:appfunctions-compiler)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getCompiler() {
                return create("androidx.appfunctions.compiler");
        }

            /**
             * Creates a dependency provider for service (androidx.appfunctions:appfunctions-service)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getService() {
                return create("androidx.appfunctions.service");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: androidGradlePlugin (8.2.0)
            ...
            /**
             * Returns the version associated to this alias: androidxComposeUi (1.6.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getAndroidxComposeUi() { return getVersion("androidxComposeUi"); }
            ...
            /**
             * Returns the version associated to this alias: androidxEspressoCore (3.5.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: appfunctions (1.0.0-alpha01)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getAppfunctions() { return getVersion("appfunctions"); }
            ...
            /**
             * Returns the version associated to this alias: composeBom (2024.02.01)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
